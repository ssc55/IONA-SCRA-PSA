...
format start %tm
gen months = ym - start //continious variable counting number of months since the start of the study
...
recode drugdetect (197=47) (198=49) (200=53) (204=62) (205=67) (206=71) (207=72) (208=74) (209=76) (210=77) (212=82) (213=83) (215=90) (217=96) (218=100) (219=101) (220=104) (222=106) (223=108) (224=131) (226=132) (228=133) (229=136) (230=140) (235=144) (237=154) (238=158) (239=164) (242=172) (243=172) (244=178) (245=181) (246=183) (248=188)
...
gen mda_trend1 = months-18
replace  mda_trend1 = 0 if months >= 18
generate mda_trend2 = months - 18 
replace  mda_trend2 = 0 if months < 18
generate mda_int1 = 1
replace  mda_int1 = 0 if months >= 18
generate mda_int2 = 1
replace  mda_int2 = 0 if months < 18

//Model estimating trend and intercept in SCRA exposure cases before/after PSA 
glm scra_month psa_trend1 psa_trend2 psa_int1 psa_int2 no_sites cos* sin*, family (poisson) link(log) scale(x2) nocons eform 
...
glm scra_month mda_trend1 mda_trend2 mda_int1 mda_int2 no_sites cos* sin*, family (poisson) link(log) scale(x2) nocons eform
...
glm nonscra_month psa_trend1 psa_trend2 psa_int1 psa_int2 no_sites cos* sin*, family (poisson) link(log) scale(x2) nocons eform 
...
glm nonscra_month mda_trend1 mda_trend2 mda_int1 mda_int2 no_sites cos* sin*, family (poisson) link(log) scale(x2) nocons eform
...
glm scra_month psa_trend1 psa_trend2 psa_int1 psa_int2 no_sites cos* sin*, family (poisson) link(log) nocons eform offset(ln_totalcount)

glm scra_month mda_trend1 mda_trend2 mda_int1 mda_int2 no_sites cos* sin*, family (poisson) link(log) nocons eform offset(ln_totalcount)

glm nonscra_month psa_trend1 psa_trend2 psa_int1 psa_int2 no_sites cos* sin*, family (poisson) link(log) nocons eform offset(ln_totalcount)

glm nonscra_month mda_trend1 mda_trend2 mda_int1 mda_int2 no_sites cos* sin*, family (poisson) link(log) nocons eform offset(ln_totalcount)
